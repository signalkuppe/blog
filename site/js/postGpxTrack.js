...
(function () {
  ...
  var coverContainer = document.getElementById('js-hasGpx')
  var caption = document.querySelector('.c-post-cover-caption')
  ...
  var showMap = function (showButton) {
    if (!mapRendered) {
      ...
      mapContainer.style.zIndex = 999 // under caption
      ...
      var gpx = coverContainer.getAttribute('data-gpx') // URL to your GPX file or the GPX itself
  ...
  var createButton = function () {
    ...
    showButton.style.zIndex = '1000'*/ // over map
    showButton.setAttribute('id', 'js-showButton')
    showButton.classList.add('c-post-cover-gpxButton')
    caption.prepend(showButton)
