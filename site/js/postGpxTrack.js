(function () {
  ...
  var showMap = function () {
    ...
    if (!mapRendered) {
      showButton.classList.add("js-is-loading");
      showButton.innerHTML = iconShow + " Carico la traccia...";
      var mapContainer = document.createElement("div");
      mapContainer.setAttribute("id", "map");
      mapContainer.style.height =
        coverContainer.getBoundingClientRect().height + "px";
      mapContainer.style.width =
        coverContainer.getBoundingClientRect().width + "px";
      ...
      new L.GPX(gpxUrl, {
        ...
        .on("loaded", function (e) {
          ...
          showButton.classList.remove("js-is-loading");
  ...
  var createInfoBox = function (gpxEvent) {
    ...
    infoBoxGpx.innerHTML =
      "Distanza: <strong>" +
      distance +
      "km</strong> | dislivello: <strong>" +
      gain +
      "m</strong>";
