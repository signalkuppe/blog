...
fetch('/_data/map-points.json')
    ...
    .then((data) => {
        ...
        wrapper.querySelector('ul').removeAttribute('role'); // accessibility issue
        document.querySelector('#js-autocomplete').removeAttribute('tabindex');
        ...
        document.querySelector('.autoComplete_wrapper');
